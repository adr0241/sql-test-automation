...
EXEC tSQLt.Run 'testCompareTables.[test for spelling mistakes between two tables]';

/* TEST RESULTS

(1 row affected)
[testCompareTables].[test for spelling mistakes between two tables] failed: (Failure) Unexpected/missing resultset rows!
...
|>  |1000       |John      |Sherlock |(021)1234567|johnsmith@gmail.com |123 Selwyn Street|Christchurch|
|>  |1001       |Tommy     |Wayne    |(021)9876543|tomwayne@outlook.com|987 Cashmere Road|Christchurch|
|>  |1002       |Jess      |Monks    |(021)6547890|jessm@yahoo.com     |10 High Street   |Rangiora    |
...
+--+-------------------------------------------------------------------+-------+-------+
|1 |[testCompareTables].[test for spelling mistakes between two tables]|     34|Failure|
----------------------------------------------------------------------------------------
