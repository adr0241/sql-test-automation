...
EXEC tSQLt.Run 'testCompareTables.[test for removed fields between two tables]';

/* TEST RESULTS

(0 rows affected)
[testCompareTables].[test for removed fields between two tables] failed: (Failure) Unexpected/missing resultset rows!
...
+--+----------------------------------------------------------------+-------+-------+
|1 |[testCompareTables].[test for removed fields between two tables]|    297|Failure|
----------------------------------------------------------------------------------------
Msg 50000, Level 16, State 10, Line 57
